...
from ..data_util import crop_pc, voxelize, crop_pc_sparse, voxelize_sparse
...
class S3DIS(Dataset):
    ...
    def __init__(self,
        ...
        #processed_root = '/code/PointNeXt-master/userhome/PointNeXt/processed'
                ...
                if voxel_size:
                    ...
                    if self.rate != 0 and self.split == 'train':
                        ...
                        coord, feat, label = crop_pc(
                            ...
                            downsample=not self.presample, variable=self.variable, shuffle=self.shuffle, mask=mask, lads = self.lads)
                    else:
                        mask = None
                        coord, feat, label = crop_pc(
                            coord, feat, label, self.split, self.voxel_size, self.voxel_max,
